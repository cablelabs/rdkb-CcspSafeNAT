...
/*----------------------------------------------------------------------------*/
 ...
 #define  CCSP_DATAMODEL_XML_FILE           "/usr/ccsp/ccsp-safenat-broadband/TR181-SafeNAT.xml"
...
ANSC_STATUS ssp_create()
{
    ...
    {
       	printf("[SafeNAT] %s exit ERROR - no memory \n", __FUNCTION__);
       return ANSC_STATUS_RESOURCES;
    }

   	printf("[SafeNAT] %s - ComponentCommonDmInit called \n", __FUNCTION__);
    ...
    if ( !pDslhLcbIf )
    {
   	...
   	printf("[SafeNAT] %s - DslhCreateCpeController called \n", __FUNCTION__);
...
ANSC_STATUS ssp_engage()
{
    ...
    else
    {
  	...
  	printf("[SafeNAT] %s - RegisterCcspDataModel called \n", __FUNCTION__);
    ...
    if ( returnStatus == ANSC_STATUS_SUCCESS )
    {
        /* System is fully initialized */
     	printf("[SafeNAT] %s - RegisterCcspDataModel success.  System is fully initialized.\n", __FUNCTION__);
     	g_pComponent_COMMON->Health = CCSP_COMMON_COMPONENT_HEALTH_Green;
    }
    else
    {
     	printf("[SafeNAT] %s - RegisterCcspDataModel returned FAILURE!!! \n", __FUNCTION__);
